...
beautiful.font = "Noto Sans Regular 14"
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key(
        { modkey, "Control" }, "[",
        function()
            awful.spawn("brightnessctl set 8%-")

            naughty.notification({
                title = "decreased brightness -8%",
                position = "top_middle",
                timeout = 1,
